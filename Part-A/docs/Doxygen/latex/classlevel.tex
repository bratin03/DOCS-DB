...
\begin{DoxyCompactList}\small\item\em Delete all segment files in the specified directory. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Creates a filename based on segment index and level order. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Creates a filename based on segment index and level order. 

Create a filename based on the segment ID and the level of the segment.


\begin{DoxyParams}{Parameters}
{\em segment\+\_\+i} & The segment index (e.\+g., segment number). \\
\hline
{\em level\+\_\+order} & The level order (e.\+g., hierarchical level). \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
std\+::string The generated filename.
\end{DoxyReturn}
...
\begin{DoxyVerb} @brief Create a filename based on the segment ID and the level of the segment.
...
\end{DoxyVerb}
 122 $\vert$ static std\+::pair$<$uint16\+\_\+t, std\+::list$<$std\+::pair$<$uint32\+\_\+t, std\+::vector$<$level $\ast$$>$$>$$>$$>$ \mbox{\hyperlink{classlevel_a0f346d6ef3fb77c0123696e71de8265e}{collect\+\_\+levels(const std\+::string \&path, uint64\+\_\+t memtable\+\_\+size)}};m the path. \begin{DoxyVerb} The segment filename is expected to be in the format "00001_00010". This
